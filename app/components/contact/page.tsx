...
export default function Contact() {
    return (
        <div id="contact" className="flex flex-col justify-center scroll-mt-20 w-full px-margin-padding bg-gradient-to-b from-secondary to-primary to-80%">
            <div className="flex justify-end w-full">
                <h1 className="text-2xl tracking-wide pt-10 text-white">Contact</h1>
            </div>
